...
function validatePassword() {
    ...
    if (input_pw.value == pw) {
        window.open("../desktop/desktop.html", "_self"); //weeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeb
    }
    else {
